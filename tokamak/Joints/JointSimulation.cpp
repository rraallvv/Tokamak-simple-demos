...
In JointSimSample1 (see below):
I: To lift the first body
...
CJointSim TokSim;
//Use this class to get a simulation like the one used in tokamak's sample1:
//CJointSimSample1 TokSim; 
...
{
	//Pass the pressed key to the sim class:
	TokSim.KeyDown(key);
...
void InitGL(int argc, char* argv[],char * WindowTitle, int WindowX, int WindowY)
{
	//---
	//This function is not important for the Tokamak simulation
	//---
...
int main(int argc, char* argv[])
{
	...
	Camera.Move(F3dVector(80,20,80));
	Camera.RotateY(45);
